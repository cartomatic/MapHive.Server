        ...
        public static IEnumerable<dm.Application> Read()
        {
            ...
            return new List<dm.Application>
            {
                new dm.Application()
                {
                    ...
                    Url = "https://app1.emapa.local/?suppressnested=true#some/hash/123/456"
                },
                new dm.Application()
                {
                    ...
                    Name ="App 2",
                    Url = "https://app2.emapa.local/?param=test param so can be sure parameterised app urls also work&suppressnested=true",
