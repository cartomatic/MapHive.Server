...
//we plug it in via Startup though
...
namespace MapHive.Server.API
{
    ...
    {
        /// <summary>
        /// cnfogures swagger docs
        /// </summary>
        /// <param name="cfg"></param>
        /// <param name="apiVersion">version number. avoid dots though as it seems to mess up the swagger generated content because of some reason</param>
        /// <param name="apiTitle"></param>
        /// <param name="xmlCommentsPath"></param>
        ...
        )
        {
            ...
            //in case of: {"schemaValidationMessages":[{"level":"error","message":"Can't read from file https://api.maphive.local:443/swagger/docs/v1"}]}
            //see: http://stackoverflow.com/questions/32188386/cant-read-from-file-issue-in-swagger-ui
            //basically: config.EnableSwagger().EnableSwaggerUi(c => c.DisableValidator());
            //or just make the api available publically
